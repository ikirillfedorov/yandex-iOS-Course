...
class FileNotebook {
    ...
    func createTestNotes() {
        ...
        add(Note(uid: nil, title: "Тестовая Длиннная заметка", content: "Тестовый Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки Текс длинной заметки ", noteColor: .white, importance: .important, destractionDate: nil))
    }
